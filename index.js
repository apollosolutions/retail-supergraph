...
import { start as inventory } from "./services/inventory/index.js";
import { start as shipping } from "./services/shipping/index.js";
import { start as gateway } from "./gateway/index.js";

(async () => {
  // start all subgraphs
  await Promise.all([orders(), products(), users(), inventory(), shipping()]);
