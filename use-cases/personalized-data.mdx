...
There are many ways to personalize data. The most common is the attachment of recommendations and/or data based on auth headers. If you look at the schema currently written for the user, you will see that it has the following additions for personalization data:
